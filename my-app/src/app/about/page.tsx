            ...
            <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
              <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <p>
                  ...
                  calistenia y juego baloncesto. Me apasiona mejorar
                  continuamente y explorar nuevas ideas en tecnología y
                  desarrollo.
                </p>
              </div>
          ...
          <section className="w-full py-12 mx-10 md:py-24 lg:py-32  flex flex-col items-center justify-center ">
            ...
            <div className="flex flex-col gap-5 w-1/2">
              ...
              <Card>
                ...
                <CardContent>
                  <p>
                    Practico gimnasio, calistenia y baloncesto regularmente.
                    Creo firmemente en mantener un equilibrio entre la mente y
                    el cuerpo.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p>
                    Me encanta leer libros sobre tecnología, desarrollo personal
                    y ciencia ficción. Siempre estoy buscando expandir mis
                    conocimientos.
                  </p>
                </CardContent>
              </Card>
